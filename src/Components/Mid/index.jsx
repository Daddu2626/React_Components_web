  ...
  return (
    <div>
      ...
      <div className="products">
        ...
        <div className="product-card">
          <img src="https://tse1.mm.bing.net/th/id/OIP.bYYQfm9g0ZQPGk8BWOT-ogHaE8?pid=Api&P=0&h=220" alt="Shoes" />
          <h3>Running Shoes</h3>
          <p>Lightweight and durable sports shoes.</p>
          <button className="buy-btn">Buy Now</button>
        </div>
        <div className="product-card">
          <img src="https://tse3.mm.bing.net/th/id/OIP.S-6JiLn9EQ5ad-wIwdvFXQHaE9?pid=Api&P=0&h=220" alt="Headphones" />
